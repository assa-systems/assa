 ...
 *  Shuttle 1 (AFIT-001):  #define THIS_SH_ADDR  0x11   #define THIS_SH_ID    "SH1"
 *  ...
 *  Shuttle 5 (AFIT-005):  #define THIS_SH_ADDR  0x15   #define THIS_SH_ID    "SH5"
 * ═══════════════════════════════════════════════════════════════════════
 */
